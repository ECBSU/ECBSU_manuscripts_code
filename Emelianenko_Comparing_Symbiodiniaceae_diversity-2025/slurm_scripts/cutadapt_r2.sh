...
#SBATCH --job-name=cutadapt_r2
#SBATCH --time=2-0
#SBATCH --mem=100G
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=40
#SBATCH --output=cutadapt-r2-%j_out.txt
...
for file in ${path}/filtN/*R1_001.fastq.gz; do
  ...
  >> cutadapt_trimming_stats_run2.txt 2>&1  # write the output in the separate .txt file
