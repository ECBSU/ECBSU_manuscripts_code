#!/usr/bin/env python3
"""
Reads all the EggNOG .annotations file and extracts the KEGG ko number. Outputs a file similar to the output from BLASTkoala. 
...
if len(sys.argv) > 2:
    ...
    outname = eggnog_file + "_KEGG_format"
out = open(outname, "w")
