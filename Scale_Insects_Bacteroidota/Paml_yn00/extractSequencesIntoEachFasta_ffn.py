...
for index, row in df.iterrows():
    ...
    filename = row.iloc[0]
    output_file_name = f"{filename}.ffn"
    ...
    with open(output_file_name, 'w') as output_handle:
        # Iterate over the sequences in the ffn file
        for record in SeqIO.parse('/Users/jinyeongchoi/Desktop/Projects/Bacteroidota/dN:dS_Symbiont_vs._free-living_bactrium_2nd/rawSeq_nt/combined.ffn', 'fasta'):
